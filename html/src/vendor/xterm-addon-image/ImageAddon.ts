...
const DEFAULT_OPTIONS: IImageAddonOptions = {
  ...
  imageEndpoint: '/__ccimg/',
  kittyForceDiacriticWidth: false
};
...
export class ImageAddon implements ITerminalAddon , IImageApi {
  ...
  private _embed: EmbedOverlay | undefined;
  ...
  public activate(terminal: ITerminalExt): void {
    ...
    // cell-anchored inline embeds (img/video/iframe DOM) over placeholder blocks
    this._embed = new EmbedOverlay(terminal, this._renderer, this._storage);
    ...
    this._disposeLater(
      ...
      terminal.onRender(range => { this._storage?.render(range); this._embed?.schedule(); }),
