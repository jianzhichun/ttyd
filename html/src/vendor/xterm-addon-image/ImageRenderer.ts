...
import { ICellSize, ITerminalExt, IImageSpec, IPlaceholderImageSpec, IRenderDimensions, IRenderService } from './Types';
...
export class ImageRenderer extends Disposable implements IDisposable {
  ...
  /**
   * Force a full-viewport re-render (drives ImageStorage.render again). Used when an
   * out-of-band placeholder image finishes loading and its cells must repaint.
   */
